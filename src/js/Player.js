...
class somiPlayer {
    ...
    displayPlayer() {
        ...
        this.video.setCurrentDom(document.querySelector('video'));
        this.video.registerVideoEvent();
        this.video.CurrentDom.load();
        this.video.CurrentDom.play();
        this.video.CurrentDom.muted=true;
        this.Controller = new PlayerController(this.video.CurrentDom);
        this.Controller.BindDomObject();
